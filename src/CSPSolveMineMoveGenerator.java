...
public class CSPSolveMineMoveGenerator extends AbstractGenerator {
    ...
    public Board generate(int x, int y, int minecount, int startx, int starty) {
        ...
        while (i < 100) {
            ...
            //Tries moving mines 25 times and checks if solvable
            while(j < 25) {
                j++;
    ...
    /**
     * Method that picks mine from set.
     * @param set given Set<Tile>
     * @return Tile that is mine
     */
