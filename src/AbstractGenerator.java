...
public abstract class AbstractGenerator {
     ...
     * @param board Board object where to move mines
     * @return changed Board if possible
     */
    public Board moveMines(Board board){
        ...
        intboard[chosenMine.y][chosenMine.x] = 0;
        intboard[chosenSafe.y][chosenSafe.x] = 9;
    ...
    /**
     * Method that picks a random Tile from given set of Tiles
     * @param set given Set<Tile>
     * @return picked Tile
     */
